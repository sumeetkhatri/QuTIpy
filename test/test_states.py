...
def test_apply_discrete_Weyl_twirl():
    assert np.all(
        np.round(apply_discrete_Weyl_twirl(Y, 3, 2), 8)
        == np.array(
            [
                [
                    4.53434212 + 1.23075852j,
                    0.0 - 0.0j,
                    0.0 - 0.0j,
                    0.0 - 0.0j,
                    0.0 - 0.0j,
                    2.54823555 + 5.68307326j,
                    0.0 - 0.0j,
                    6.27040133 + 4.54608611j,
                    0.0 - 0.0j,
                ],
                [
                    -0.0 + 0.0j,
                    4.22910745 + 4.22188345j,
                    0.0 - 0.0j,
                    4.37659534 + 2.10502631j,
                    0.0 - 0.0j,
                    0.0 + 0.0j,
                    0.0 - 0.0j,
                    0.0 - 0.0j,
                    2.93324642 + 3.21696702j,
                ],
                [
                    0.0 + 0.0j,
                    -0.0 + 0.0j,
                    4.11114728 + 5.15115399j,
                    -0.0 + 0.0j,
                    4.17682776 + 5.30501906j,
                    0.0 + 0.0j,
                    5.06028291 + 2.45018037j,
                    0.0 - 0.0j,
                    0.0 - 0.0j,
                ],
                [
